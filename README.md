...
* **CSS3:** Variables personalizadas, Flexbox y diseño de componentes (Badges, Buttons).
* **JavaScript (Vanilla):** Manipulación del DOM, eventos, filtrado de arrays y almacenamiento local.

## 📦 Instalación y Uso

1. Clona este repositorio:
   ```bash
   git clone https://github.com/ainoadura/taskflow-project.git
